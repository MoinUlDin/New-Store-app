...
class AddUpdateItem(QWidget):
    ...
    def _build_ui(self):
        ...
        self.btn_add_category.setFixedHeight(self.cmb_category.sizeHint().height() or 30)
        ...
        self.inp_initial_stock.setDecimals(2)
    ...
    def apply_language(self, lang: str):
        ...
        for u in self.units_list:
            self.cmb_unit.addItem(screen_t(u, lang))
